...
function Alltasks() {
    ...
    // const [alltasks, Setall] = useState(() => JSON.parse(localStorage.getItem("tasks")) || []);
...
// FOR API START
    ...
    // useEffect(()=>{
    //     const name = prompt("Please enter your name:");                                   //DOUBT
    //     setName(name)
    // },[])
...
//    //FOR LOCAL STORAGE END
    ...
    return (
        <div div className='all'>
            ...
            {/* <h2><strong>Hello,{Name} Welcome back</strong></h2> */}
